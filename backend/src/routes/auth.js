...
router.patch('/preferences', async (req, res) => {
  ...
  const { theme, font, layout, notificationSound, pageSize, scrollMode, syncInterval,
          ...
          threadedView, plaintextEmail, hoverDeleteEnabled } = req.body;
  ...
  await query(`
    ...
    SET preferences = preferences
      ...
      || CASE WHEN $16::boolean IS NOT NULL THEN jsonb_build_object('hoverDeleteEnabled', $16::boolean) ELSE '{}'::jsonb END
    WHERE id = $1
  `, [req.session.userId, theme ?? null, font ?? null, layout ?? null, notificationSound ?? null,
      ...
      language ?? null, threadedView ?? null, plaintextEmail ?? null, hoverDeleteEnabled ?? null]);
